...
public class Array_sort_studentid {
	...
	public static void main(String[] args) {
        ...
        studentArray[0] = new Student(3, "Jack");
        studentArray[1] = new Student(1, "Ryan");
        studentArray[2] = new Student(5, "Jay");
        studentArray[3] = new Student(2, "Adam");
         ...
         */
        Arrays.sort(studentArray, 0, 4, new StudentComparator());
